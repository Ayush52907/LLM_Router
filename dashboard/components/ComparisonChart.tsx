...
export const ComparisonChart: React.FC<ComparisonChartProps> = ({
  ...
  return (
    <div className="bg-[#0a0a0a] border border-[#262626] rounded-lg p-4 text-left shadow-sm">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div>
          <div className="flex justify-between text-xs font-mono mb-1.5">
            <span className="text-neutral-400 uppercase font-medium">Total Cost</span>
            <span className="text-white font-semibold">${thisSystem.cost.toFixed(4)}</span>
          </div>
        ...
        <div>
          <div className="flex justify-between text-xs font-mono mb-1.5">
            <span className="text-neutral-400 uppercase font-medium">Total Carbon</span>
            <span className="text-white font-semibold">{thisSystem.carbon.toFixed(5)} kg</span>
          </div>
        ...
        <div>
          <div className="flex justify-between text-xs font-mono mb-1.5">
            <span className="text-neutral-400 uppercase font-medium">Quality Retained</span>
            <span className="text-white font-semibold">{(thisSystem.quality * 100).toFixed(1)}%</span>
          </div>
          ...
          <div className="space-y-1.5 text-[10px] font-mono">
            <div>
              ...
              <div className="w-full h-1.5 bg-[#171717] rounded-full overflow-hidden">
                <div className="bg-[#525252] h-full w-full" />
              </div>
            </div>
      ...
      <div className="flex items-center justify-end gap-5 mt-3 pt-2 border-t border-[#262626] text-[10px] font-mono text-neutral-400">
        <span className="flex items-center gap-1.5">
          <span className="w-2.5 h-2.5 rounded-sm bg-white" />
          Direct Task Work
        </span>
        <span className="flex items-center gap-1.5">
          <span className="w-2.5 h-2.5 rounded-sm bg-[#737373]" />
